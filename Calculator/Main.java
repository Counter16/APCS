...
class Main {
  public static void main(String[] args) {
    ...
    System.out.println("List an expression you need to solve. Don't include any spaces.");
  ...
  public static int chickenNugget(String chicken){
    ...
    int count = 0;
    System.out.println(evaluate(elements, count));
    return 0;
  }
  public static int evaluate(ArrayList<String> elements, int count){  
